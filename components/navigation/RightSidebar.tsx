...
const hotQuestions = [
    ...
    {
        _id: "3", title: "How to create custom hook in react ?"
    },
    {
        _id: "4", title: "How to create custom hook in react ?"
    },
];
...
const RightSidebar = () => {
    return (
        <section className='pt-36 custom-scrollbar 
            ...
            flex h-screen w-[350px] flex-col gap-6 overflow-y-auto border-1
            ...
            <div>
                ...
                <div className='mt-7 flex w-full flex-col gap-[30px]'>
                    {hotQuestions.map(({_id, title}) => (
                        <Link key={_id} href={ROUTES.PROFILE(_id)} className='flex cursor-pointer items-center justify-between
                        gap-7'>
